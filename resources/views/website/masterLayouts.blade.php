                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li><a href="{{route('partners')}}">نمایندگی ها</a></li>
    ...
    <footer class="site-footer" dir="rtl" style="text-align: right">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <h3 class="footer-heading mb-4 text-white">{{$bio->companyName}}</h3>
          ...
          <div class="col-md-4">
            ...
            <p><span class="icon-map" style="color: orange"></span> {{$bio->address}}</p><br>
            <p><span class="icon-phone" style="color: orange"> تلفن</span><br>{{$bio->phone1}}<br>{{$bio->phone2}}</p><br>
