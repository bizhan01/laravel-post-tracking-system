...
<html lang="en" >
          ...
          <div class="py-1">
            <div class="row align-items-center">
              <div class="col-2">
                ...
                <a href="#"><img class="mb-0 site-logo" src="/website/images/logo.jpg" alt="" /></a>
              </div>
                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      <li><a href="<?php echo e(route('welcome')); ?>">خانه</a></li>
                      <li><a href="<?php echo e(route('services')); ?>">خدمات</a></li>
                      <li><a href="<?php echo e(route('partners')); ?>">نمایندگی ها</a></li>
                      <li><a href="<?php echo e(route('about')); ?>">درباره</a></li>
                      <li><a href="<?php echo e(route('contactUs')); ?>">تماس باما</a></li>
                    </ul>
                  </div>
                </nav>
              </div>
    ...
    <footer class="site-footer" dir="rtl" style="text-align: right">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <h3 class="footer-heading mb-4 text-white"><?php echo e($bio->companyName); ?></h3>
            <hr style="color: orange">
            <p><?php echo e($bio->description); ?></p>
            <p><a href="#" class="btn btn-warning pill text-white px-4">بیشتر بخوانید</a></p>
          </div>

          <div class="col-md-4">
            <h3 class="footer-heading mb-4 " style="color: orange; border-bottom: 1px solid white; line-height: 50px; ">آدرس ما</h3>
            <p><span class="icon-map" style="color: orange"></span> <?php echo e($bio->address); ?></p><br>
            <p><span class="icon-phone" style="color: orange"> تلفن</span><br><?php echo e($bio->phone1); ?><br><?php echo e($bio->phone2); ?></p><br>
            <p><span class="icon-at" style="color: orange"> ایمیل آدرس</span><br><br><?php echo e($bio->email); ?></p><br>
          </div>


          <div class="col-md-4">
            <h3 class="footer-heading mb-4" style="color: orange; border-bottom: 1px solid white; line-height: 50px; " >دسترسی سریع</h3>
              <ul class="list-unstyled">
                <li><a href="index.html">خانه</a></li>
                <li><a href="serviceses.html">خدمات</a></li>
                <li><a href="partners.html">همکاران / شرکا</a></li>
            ...
            <div class="col-md-12"><h3 class="footer-heading mb-4" style="color: orange; border-bottom: 1px solid white; line-height: 50px; ">مارا در شبکه های اجتماعی دنبال کنید</h3></div>
              <p>
                <a href="#" class="pb-2 pr-2 pl-0"><span class="icon-facebook" style="color: orange"></span></a>
                <a href="#" class="p-2"><span class="icon-twitter" style="color: orange"></span></a>
                <a href="#" class="p-2"><span class="icon-instagram" style="color: orange"></span></a>
                <a href="#" class="p-2"><span class="icon-vimeo" style="color: orange"></span></a>
              </p>
          </div>
        ...
        <div class="row pt-12 mt-12 text-center" style="background-color: orange">
          <div class="col-md-12">
            <p style="color: black; padding-top: 15px">
              کلیه حقوق مادی و معنوی این ویب مربوط شرکت افغان پست میباشد
            </p>
          </div>
        </div>
  ...
  <script src="<?php echo e(asset('../website/js/mediaelement-and-player.min.js')); ?>"></script>
