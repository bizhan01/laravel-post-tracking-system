...
<head>
	...
	<body class="fixed-sidebar fixed-header skin-default">
		...
		<script type="text/javascript" src="<?php echo e(asset('js/charts-flot.js')); ?>"></script>
		<script type="text/javascript" src="<?php echo e(asset('js/custom.js')); ?>"></script>

		<script type="text/javascript" src="<?php echo e(asset('../select2/dist/js/select2.min.js')); ?>"></script>
		<link rel="stylesheet" href="<?php echo e(asset('../select2/dist/css/select2.css')); ?>">
