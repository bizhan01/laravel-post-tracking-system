				...
				<div class="card profile-card">
					...
					<ul class="list-group">
						<a class="list-group-item" href="#">
							<i class="ti-worlds mr-0-5"></i>
							<span>نمایندگی:</span>
							<span><?php echo e(Auth::user()->site); ?></span>
						</a>
					</ul>
					<ul class="list-group">
						<a class="list-group-item" href="#" >
							...
							<span style="direction: ltr; text-align: left"><?php echo e(Auth::user()->phone_number); ?></span>
						</a>
					</ul>
					<ul class="list-group">
						<a class="list-group-item" href="#">
							...
							<form method="post" action="<?php echo e(route('updateNameUser')); ?>">
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-12 col-md-8 col-lg-6">
										...
										<input type="text" name="phone_number" placeholder="0799999999" data-mask="0799999999" class="form-control" style="direction: ltr" value="<?php echo e(Auth::user()->phone_number); ?>">
									</div>
									<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2"></div>
								</div>
								<div class="row">
									...
									<div class="col-xs-12 col-sm-12 col-md-8 col-lg-6">
										...
										<input type="name" name="address" class="form-control" value="<?php echo e(Auth::user()->address); ?>">
									</div>
									<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2"></div>
								</div>
								<div class="row">
